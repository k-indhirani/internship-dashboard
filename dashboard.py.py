...
with col2:
    ...
    fig2 = px.bar(dept_hours, x='Department', y='Hours_Spent', title='Total Hours by Department')
    st.plotly_chart(fig2, use_container_width=True)

col3, col4 = st.columns(2)
with col3:
    fig3 = px.scatter(filtered_df, x='Team_Members', y='Hours_Spent', color='Status', title='Team Size vs Hours_Spent')
